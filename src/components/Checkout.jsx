  ...
  return (
    <>
      ...
      <div className="container">
        <div className="row">
          <h2 className="title mt-5 mb-5">SECURE CHECKOUT</h2>
          <hr />
          <div className="col-8 text-start border-rigth">
            <div className="mt-5 mb-5 d-flex " id="payment-options">
              <svg
              ...
              <p className="mt-3">BUSINESS DELIVERY</p>
            </div>
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group className="mb-3" controlId="formBasicAdress1">
              ...
              <Form.Group className="mb-3" controlId="formBasicCity">
                <Form.Label className="title imput-lable">CITY *</Form.Label>
                <Form.Control
                  type="text"
              ...
              <Form.Group className="mb-3" controlId="formBasicState">
                <Form.Label className="title imput-lable">STATE *</Form.Label>
                <Form.Control
                  type="text"
              ...
              <Form.Group className="mb-3" controlId="formBasicZip">
                <Form.Label className="title imput-lable">ZIP CODE *</Form.Label>
                <Form.Control
                  type="text"
              ...
              <Form.Group className="mb-3" controlId="formBasicPhone">
                <Form.Label className="title imput-lable">PHONE NUMBER *</Form.Label>
                <Form.Control
                  type="text"
              ...
              <div className="mt-5 d-flex " id="payment-options">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 576 512"
                  width="25px"
              ...
              <Form.Group className="my-5" controlId="formBasicCadNumber">
                <Form.Label className="title imput-lable">PAYMENT OPTIONS *</Form.Label>
                <Form.Select aria-label="Credit Card" className="">
              ...
              <div id="pay-div">
                <Row>
                  <Form.Group className="mb-3 mt-3" controlId="formBasicCadNumber">
                    <Form.Label className="title imput-lable">CARD NUMBER *</Form.Label>
                    <Form.Control
                      type="text"
                  ...
                  <Form.Group as={Col} className="mb-3" controlId="formBasicdate">
                    <Form.Label className="title imput-lable">EXPIRY DATE *</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="MM/YY"
                      required
                  ...
                  <Form.Group as={Col} className="mb-3" controlId="formBasicCVC">
                    <Form.Label className="title imput-lable">CVC/CVV *</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="123"
                      required
                  ...
                  <Form.Group className="mb-3" controlId="formBasicPhone">
                    <Form.Label className="title imput-lable">NAME ON CARD *</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="J. Smith "
                      required
              ...
              <button className="add-bag mt-4" type="submit">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  width="18px"
          ...
          <div className="col-4 ">
            {bag.map((product, index) => (
              <ProductBill key={index} product={product} />
            ))}
            <hr />
            <div className="d-flex justify-content-between title mt-2 fw-bold">
              <p>SUBTOTAL:</p>
              <p>$USD {total}</p>
            </div>
            ...
            <hr />
            <div className="d-flex justify-content-between title mt-4 fw-bold">
              <p>TOTAL:</p>
              <div>
                <p>$USD {total}</p>
              </div>
        ...
        <hr />
        <div className="row checout-font fw-bold mb-5 mt-5">
          <div className="col-12 col-lg-4">
            <p>COMPLIMENTARY SHIPPING</p>
            <p>
              We offer Standard, Next Day and Saturday delivery. We also provide Boutique Pick-up
              for free depending on your location.
            </p>
          </div>
          <div className="col-12 col-lg-4">
            <p>PAYMENT OPTIONS</p>
            <p>
              Officine Panerai guarantees secure transactions with the following payment methods:
            ...
            <div>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <rect width="780" height="500" fill="#FFF" strokeWidth="15px" stroke="#000" />
                <path
          ...
          <div className="col-12 col-lg-4">
            ...
            <p>
              You can easily return your online order within 14 days. Our ambassadors are available
              to guide you by phone or email. For more information, visit our FAQ.
            </p>
          </div>
        </div>
      </div>
